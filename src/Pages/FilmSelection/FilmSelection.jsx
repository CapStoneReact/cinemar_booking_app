...
import { fetchShowtimeFilm, setShowTimeReset } from "../../Slices/showfilm";
...
export default function FilmSelection(props) {
  ...
  let showtimeList;
  let optionCinemas = [];
  if (movie?.heThongRapChieu && movie?.heThongRapChieu.length > 0) {
    showtimeList = movie.heThongRapChieu;
