...
import { updateUser } from "../../Slices/userAuth";
...
export default function AccountTicket(props) {
  const classes = useStyles();
  const { userInfoStorage } = props;
  ...
  //   let userInfoStorage = JSON.parse(localStorage.getItem("uer"));
  //   if (localStorage.getItem("user")) {
  //     userInfoStorage = JSON.parse(localStorage.getItem("uer"));
